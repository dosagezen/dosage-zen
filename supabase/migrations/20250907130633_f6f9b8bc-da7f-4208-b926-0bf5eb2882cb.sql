-- Remove TODAS as políticas que podem causar conflito
...
DROP POLICY IF EXISTS "Admins can manage admin user roles" ON public.user_roles;
...
-- Recria políticas usando a função security definer (sem recursão)
...
CREATE POLICY "Admins can insert admin user roles"
